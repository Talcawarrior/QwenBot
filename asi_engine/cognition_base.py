...
class CognitionNode:
    ...
    def __init__(self, run_round: int, hypothesis: str, brier_score: float,
                 roi: float, win_rate: float, causal_insight: str, parameters: dict):
            ...
            if not os.path.exists(COGNITION_PATH):
                ...
                self.nodes = [
                    CognitionNode(
                        ...
                        roi=0.0,
                        win_rate=0.50,
                        causal_insight="Human Prior: Equal weights assume GFS, ECMWF, and regional models have equal accuracy globally. Historical analysis shows ECMWF and GFS usually outperform regional models.",
                        parameters={
                            "model_weights": {
                                "gfs_seamless": 0.125,
                                "ecmwf_ifs04": 0.125,
                    ...
                    CognitionNode(
                        ...
                        roi=12.5,
                        win_rate=0.58,
                        causal_insight="Human Prior: Global forecasts like ECMWF and GFS have much larger data assimilation systems. They consistently exhibit lower Brier scores across both US and European cities.",
                        parameters={
                            "model_weights": {
                                "gfs_seamless": 0.30,
                                "ecmwf_ifs04": 0.25,
